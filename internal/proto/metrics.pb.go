//go:generate protoc --go_out=. --go-grpc_out=. --proto_path=. metrics.proto
...
const file_internal_proto_metrics_proto_rawDesc = "" +
	...
	"\aMetrics\x12N\n" +
	"\rUpdateMetrics\x12\x1d.metrics.UpdateMetricsRequest\x1a\x1e.metrics.UpdateMetricsResponseB\x12Z\x10./internal/protob\x06proto3"
